  ...
  <Container>
    <div className="relative flex items-center justify-between h-16">
      <div className="absolute inset-y-0 right-0 flex items-center lg:hidden">
        {/* <!-- Mobile menu button--> */}
        <button onClick={() => setOpen(!open)} className="inline-flex items-center justify-center p-2 rounded-md text-gray-800 text-opacity-80 hover:text-gray-200 hover:bg-yellow-900 bg-opacity-80 focus:outline-none focus:ring-0 focus:ring-inset focus:ring-gray-600 transition duration-150 ease-in-out" aria-expanded="false">
      ...
      <div className="flex-1 flex items-center justify-center lg:items-stretch lg:justify-between">
        <div className="flex-shrink-0 flex items-center">
          <h1 className="text-original-8 text-opacity-80 font-semibold font-serif px-2 py-0.5 border-0 lg:border border-original-8 rounded">Alexander v.P.H. Dobbrunz</h1>
        </div>
        <div className="hidden lg:block lg:ml-6">
          <div className="flex space-x-4">
            {/* <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" --> */}
            <NavigationLink href='#'>Philosophie</NavigationLink>
            <NavigationLink href='#'>Wirtschaftliches Engagement</NavigationLink>
            <NavigationLink href='#'>Soziales &amp; Gesellschaftliches</NavigationLink>
